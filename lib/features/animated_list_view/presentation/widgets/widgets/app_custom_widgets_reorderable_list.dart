...
import 'package:flutter_examples/features/animated_list_view/presentation/widgets/multi_drag/app_custom_multi_drag.dart';
...
///    its items.
///  * [AppCustomSliverReorderableList], a sliver list that allows the user to reorder
///    its items.
...
/// [ReorderableList] and [AppCustomSliverReorderableList].
///
...
/// [AppCustomReorderableDelayedDragStartListener]. These will take care of recognizing
...
class ReorderableList extends StatefulWidget {
  ...
  /// [AppCustomReorderableDelayedDragStartListener]).
  /// {@endtemplate}
...
class ReorderableListState extends State<ReorderableList> {
  final GlobalKey<AppCustomSliverReorderableListState>
  ...
  /// [ReorderableDragStartListener] or [AppCustomReorderableDelayedDragStartListener]
  /// which call this for the application.
  void startItemDragReorder({
    required int index,
    required PointerDownEvent event,
    required AppCustomMultiDragGestureRecognizer recognizer,
  }) {
...
/// [AppCustomSliverReorderableListState.startItemDragReorder]. This is most easily
/// achieved by wrapping each child in a [ReorderableDragStartListener] or
/// a [AppCustomReorderableDelayedDragStartListener]. These will take care of
/// recognizing the start of a drag gesture and call the list state's start
/// item drag method.
///
/// This widget's [AppCustomSliverReorderableListState] can be used to manually start an item
/// reorder, or cancel a current drag that's already underway. To refer to the
/// [AppCustomSliverReorderableListState] either provide a [GlobalKey] or use the static
/// [AppCustomSliverReorderableList.of] method from an item's build method.
///
/// See also:
///
...
///  * [ReorderableListView], a Material Design list that allows the user to
///    reorder its items.
class AppCustomSliverReorderableList extends StatefulWidget {
  /// Creates a sliver list that allows the user to interactively reorder its
  /// items.
  ///
  /// The [itemCount] must be greater than or equal to zero.
  const AppCustomSliverReorderableList({
    super.key,
    required this.itemBuilder,
  ...
  @override
  AppCustomSliverReorderableListState createState() =>
      AppCustomSliverReorderableListState();

  /// The state from the closest instance of this class that encloses the given
  /// context.
  ///
  /// This method is typically used by [AppCustomSliverReorderableList] item widgets to
  /// start or cancel an item drag operation.
  ///
  /// If no [AppCustomSliverReorderableList] surrounds the context given, this function
  /// will assert in debug mode and throw an exception in release mode.
  ///
  /// This method can be expensive (it walks the element tree).
  ///
  ...
  ///
  ///  * [maybeOf], a similar function that will return null if no
  ///    [AppCustomSliverReorderableList] ancestor is found.
  static AppCustomSliverReorderableListState of(BuildContext context) {
    final AppCustomSliverReorderableListState? result =
        context.findAncestorStateOfType<AppCustomSliverReorderableListState>();
    assert(() {
      if (result == null) {
        throw FlutterError.fromParts(<DiagnosticsNode>[
          ErrorSummary(
  ...
  /// context.
  ///
  /// This method is typically used by [AppCustomSliverReorderableList] item widgets that
  /// insert or remove items in response to user input.
  ///
  /// If no [AppCustomSliverReorderableList] surrounds the context given, this function
  /// will return null.
  ...
  /// See also:
  ///
  ///  * [of], a similar function that will throw if no [AppCustomSliverReorderableList]
  ///    ancestor is found.
  static AppCustomSliverReorderableListState? maybeOf(BuildContext context) {
    return context
        .findAncestorStateOfType<AppCustomSliverReorderableListState>();
  }
}
...
///
/// An app that needs to start a new item drag or cancel an existing one
/// can refer to the [AppCustomSliverReorderableList]'s state with a global key:
///
/// ```dart
...
/// ```
///
/// [ReorderableDragStartListener] and [AppCustomReorderableDelayedDragStartListener]
/// refer to their [AppCustomSliverReorderableList] with the static
/// [AppCustomSliverReorderableList.of] method.
class AppCustomSliverReorderableListState
    extends State<AppCustomSliverReorderableList>
  ...
  AppCustomMultiDragGestureRecognizer? _recognizer;
  ...
  @override
  void didUpdateWidget(covariant AppCustomSliverReorderableList oldWidget) {
...
class _ReorderableItemState extends State<_ReorderableItem> {
  late AppCustomSliverReorderableListState _listState;
  ...
  @override
  void initState() {
    _listState = AppCustomSliverReorderableList.of(context);
...
/// See also:
///
///  * [AppCustomReorderableDelayedDragStartListener], a similar wrapper that will
...
class ReorderableDragStartListener extends StatelessWidget {
  ...
  @protected
  AppCustomMultiDragGestureRecognizer createRecognizer() {
    return AppCustomImmediateMultiDragGestureRecognizer(debugOwner: this);
  }

  void _startDragging(BuildContext context, PointerDownEvent event) {
    final DeviceGestureSettings? gestureSettings =
        MediaQuery.maybeGestureSettingsOf(context);
    final AppCustomSliverReorderableListState? list =
        AppCustomSliverReorderableList.maybeOf(context);
...
///  * [ReorderableListView], a Material Design list that allows the user to
///    reorder its items.
class AppCustomReorderableDelayedDragStartListener
  ...
  /// list.
  const AppCustomReorderableDelayedDragStartListener({
    super.key,
  ...
  @override
  AppCustomMultiDragGestureRecognizer createRecognizer() {
    return AppCustomDelayedMultiDragGestureRecognizer(debugOwner: this);
  }
}
...
class _DragInfo extends Drag {
  ...
  late AppCustomSliverReorderableListState listState;
  late int index;
  late Widget child;
  ...
  void startDrag() {
    _proxyAnimation = AnimationController(
      ...
      ..addStatusListener((AnimationStatus status) {
        coloredPrint('animation controller listener', status.name);
...
class _DragItemProxy extends StatelessWidget {
  ...
  final AppCustomSliverReorderableListState listState;
  final int index;
  final Widget child;
...
class _ReorderableItemGlobalKey extends GlobalObjectKey {
  ...
  final Key subKey;
  final int index;
  final AppCustomSliverReorderableListState state;
